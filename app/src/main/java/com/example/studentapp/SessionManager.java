...
public class SessionManager {
    ...
    public static final String KEY_IADDRESS = "iaddress";
    ...
    //Login Sessions
    public void createLoginSession(String fullName, String email, String haddress, String iaddress, String age, String gender, String phone_No, String password) {
        editor.putBoolean(IS_LOGIN, true);

        editor.putString(KEY_NAME, fullName);
        editor.putString(KEY_EMAIL, email);
        editor.putString(KEY_HADDRESS, haddress);
        editor.putString(KEY_IADDRESS, iaddress);
    ...
    public HashMap<String, String> getUserDetailFromSession() {
        ...
        userData.put(KEY_IADDRESS, userSession.getString(KEY_IADDRESS, null));
