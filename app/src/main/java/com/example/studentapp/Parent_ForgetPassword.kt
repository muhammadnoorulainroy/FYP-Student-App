...
class Parent_ForgetPassword : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ph_number = findViewById((R.id.pfp_ph_number))
        progressBar = findViewById((R.id.pfp_progress_bar))
    }
        ...
        checkUser.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    val intent = Intent(applicationContext, Parent_FPVerifyOTP::class.java)
            ...
            override fun onCancelled(error: DatabaseError) {
                progressBar!!.visibility = View.GONE
                Toast.makeText(this@Parent_ForgetPassword, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        })
    }
