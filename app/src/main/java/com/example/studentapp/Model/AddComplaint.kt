...
import com.example.studentapp.ComplaintHelperClass
import com.example.studentapp.R
import com.example.studentapp.SessionManager
...
class AddComplaint : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sessionManager =
            SessionManager(this@AddComplaint, SessionManager.SESSION_USERSESSION)
